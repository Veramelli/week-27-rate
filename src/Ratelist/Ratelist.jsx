...
const cards = [
  ...
  { title: "Безлимитный 550", price: "550", speed:"100", description: "Объем включенного траффика не ограничен", titleColor:"rgb(236, 93, 93)", priceColor:"rgb(255, 183, 183)", isSelected: true},
